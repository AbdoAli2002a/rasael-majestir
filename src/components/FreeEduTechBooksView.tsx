...
import { Search, BookOpen, User, Calendar, Download, ExternalLink, Hash } from "lucide-react";
...
export function FreeEduTechBooksView() {
  const [items, setItems] = useState<FreeBook[]>([]);
  ...
  return (
    <div className="mx-auto max-w-7xl px-4 py-10 md:px-6">
      <div className="mb-8">
        <h1 className="text-3xl font-bold text-foreground md:text-4xl">الكتب المجانية في تكنولوجيا التعليم</h1>
        <p className="mt-2 text-muted-foreground">مجموعة من الكتب المجانية المتخصصة في مجال تكنولوجيا التعليم مع روابط تحميل مباشرة.</p>
      </div>
                  ...
                  {it.download_url ? (
                    <Button asChild className="w-full">
                      <a
                        ...
                        aria-label={`تحميل الكتاب: ${it.title}`}
                      >
